...
if ( ! function_exists('pets_grooming_get_not_selected_text') ) {
	/**
	 ...
	 */
	function pets_grooming_get_not_selected_text( $label ) {
		return apply_filters( 'pets_grooming_filter_not_selected_text',
								sprintf( apply_filters( 'pets_grooming_filter_not_selected_mask', __( '- %s -', 'pets-grooming' ) ), $label )
							);
	}
}

if ( ! function_exists( 'pets_grooming_get_list_range' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'pets_grooming_get_list_styles' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'pets-grooming' ), $i );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'pets-grooming' ),
			'no'  => esc_html__( 'No', 'pets-grooming' ),
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function pets_grooming_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'pets-grooming' ),
				0         => esc_html__( 'No', 'pets-grooming' ),
			)
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'pets_grooming_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'pets-grooming' ),
			'off' => esc_html__( 'Off', 'pets-grooming' ),
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'pets-grooming' ),
			'hide' => esc_html__( 'Hide', 'pets-grooming' ),
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'pets-grooming' ),
			'hidden'  => esc_html__( 'Hidden', 'pets-grooming' ),
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_directions' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'pets-grooming' ),
			'vertical'   => esc_html__( 'Vertical', 'pets-grooming' ),
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'pets-grooming' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'pets-grooming' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'pets-grooming' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'pets-grooming' ),
...
if ( ! function_exists( 'pets_grooming_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'pets-grooming' ),
				'icon'    => esc_html__( 'Icon', 'pets-grooming' ),
				'icons'   => esc_html__( 'Icons', 'pets-grooming' ),
				'zoom'    => esc_html__( 'Zoom', 'pets-grooming' ),
				'fade'    => esc_html__( 'Fade', 'pets-grooming' ),
				'slide'   => esc_html__( 'Slide', 'pets-grooming' ),
				'pull'    => esc_html__( 'Pull', 'pets-grooming' ),
				'border'  => esc_html__( 'Border', 'pets-grooming' ),
				'excerpt' => esc_html__( 'Excerpt', 'pets-grooming' ),
				'info'    => esc_html__( 'Info', 'pets-grooming' ),
			)
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'pets_grooming_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'pets-grooming' ),
				'fullpost' => esc_html__( 'Full post', 'pets-grooming' ),
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function pets_grooming_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'pets-grooming' ),
...
if ( ! function_exists( 'pets_grooming_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = pets_grooming_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			pets_grooming_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = pets_grooming_array_merge( array( 'hide' => pets_grooming_get_not_selected_text( esc_html__( 'Select widgets', 'pets-grooming' ) ) ), $list );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function pets_grooming_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'pets-grooming' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'pets-grooming' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'pets-grooming' ),
...
if ( ! function_exists( 'pets_grooming_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'pets-grooming' ),
				'below' => esc_html__( 'Below the content', 'pets-grooming' ),
				'float' => esc_html__( 'Floating bar', 'pets-grooming' ),
			)
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'pets_grooming_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'pets_grooming_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'pets_grooming_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'pets_grooming_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_header_positions( $prepend_inherit = false ) {
		$list = apply_filters( 'pets_grooming_filter_list_header_positions', array(
			'default' => esc_html__( 'Default', 'pets-grooming' ),
			'over'    => esc_html__( 'Over', 'pets-grooming' ),
			'under'   => esc_html__( 'Under', 'pets-grooming' ),
		) );
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'pets_grooming_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function pets_grooming_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'pets-grooming' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'pets-grooming' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'pets_grooming_filter_allow_fullscreen', $force_fullscreen || pets_grooming_get_theme_setting( 'allow_fullscreen' ) || pets_grooming_get_edited_post_type() == 'page' ) ) {
			if ( pets_grooming_get_theme_setting( 'allow_fullwide', true ) ) {
				$list['fullwide']   = array(
										'title' => esc_html__( 'Fullwidth', 'pets-grooming' ),
										'icon'  => 'images/theme-options/body-style/fullwide.png',
										);
			}
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'pets-grooming' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'pets_grooming_filter_list_body_styles', $list );
		return $prepend_inherit
					? pets_grooming_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'pets_grooming_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function pets_grooming_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'pets-grooming' ),
				...
				array(
					'normal' => array(
							'title' => esc_html__( 'Normal', 'pets-grooming' ),
...
if ( ! function_exists( 'pets_grooming_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function pets_grooming_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'pets-grooming' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'pets-grooming' ),
...
if ( ! function_exists( 'pets_grooming_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'pets-grooming' ),
				'date'       => esc_html__( 'Published date', 'pets-grooming' ),
				'modified'   => esc_html__( 'Modified date', 'pets-grooming' ),
				'views'      => esc_html__( 'Views', 'pets-grooming' ),
				'likes'      => esc_html__( 'Likes', 'pets-grooming' ),
				'comments'   => esc_html__( 'Comments', 'pets-grooming' ),
				'share'      => esc_html__( 'Share links', 'pets-grooming' ),
				'categories' => esc_html__( 'Categories', 'pets-grooming' ),
				'edit'       => esc_html__( 'Edit link', 'pets-grooming' ),
			)
		);
...
if ( ! function_exists( 'pets_grooming_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_list_share_links_positions',
			array(
				'top'    => esc_html__( 'Top', 'pets-grooming' ),
...
if ( ! function_exists( 'pets_grooming_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function pets_grooming_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'pets-grooming' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'pets-grooming' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'pets_grooming_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? pets_grooming_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'pets_grooming_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function pets_grooming_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'pets_grooming_filter_list_single_styles', pets_grooming_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? pets_grooming_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'pets_grooming_get_list_categories' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_categories( $prepend_inherit = false ) {
		$list = pets_grooming_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'pets_grooming_filter_term_name', $cat->name, $cat );
				}
			}
			pets_grooming_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_terms' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = pets_grooming_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'pets_grooming_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			pets_grooming_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_posts_types( $prepend_inherit = false ) {
		$list = pets_grooming_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'pets_grooming_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'pets-grooming' ),
				)
			);
			pets_grooming_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_posts' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = pets_grooming_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? pets_grooming_get_not_selected_text( esc_html__( 'Not selected', 'pets-grooming' ) ) : $opt['not_selected'];
			}
			$args = array(
			...
			pets_grooming_storage_set( $hash, $list );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_pages' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_pages( $prepend_inherit = false, $opt = array() ) {
		...
		return pets_grooming_get_list_posts( $prepend_inherit, $opt );
	}
}

if ( ! function_exists( 'pets_grooming_get_list_users' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = pets_grooming_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = pets_grooming_get_not_selected_text( esc_html__( 'Not selected', 'pets-grooming' ) );
			$users        = get_users(
				array(
			...
			pets_grooming_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_menus' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_menus( $prepend_inherit = false ) {
		$list = pets_grooming_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			...
			pets_grooming_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_icons' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = pets_grooming_is_off( pets_grooming_get_theme_option( 'debug_mode' ) ) ? get_transient( 'pets_grooming_list_icons' ) : false;
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			$lists = array();
			if ( 'icons' == $style ) {
				$lists[ $style ] = pets_grooming_array_from_list( pets_grooming_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = pets_grooming_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = pets_grooming_get_list_images( false, 'svg' );
			}
			if ( pets_grooming_is_off( pets_grooming_get_theme_option( 'debug_mode' ) ) && is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'pets_grooming_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'pets_grooming_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function pets_grooming_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : pets_grooming_parse_icons_classes( pets_grooming_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = ! is_array( $list ) ? array() : pets_grooming_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'pets_grooming_get_list_images' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'pets_grooming_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function pets_grooming_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'pets_grooming_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'pets-grooming' ),
				'link2'   => esc_html__( 'Accent 2', 'pets-grooming' ),
				'link3'   => esc_html__( 'Accent 3', 'pets-grooming' ),
				'dark'    => esc_html__( 'Dark', 'pets-grooming' ),
			)
		);
		return $prepend_inherit ? pets_grooming_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'pets-grooming' ) ), $list ) : $list;
	}
