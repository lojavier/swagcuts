...
if ( ! function_exists( 'pets_grooming_gutenberg_get_css' ) ) {
	add_filter( 'pets_grooming_filter_get_css', 'pets_grooming_gutenberg_get_css', 10, 2 );
	function pets_grooming_gutenberg_get_css( $css, $args ) {
