...
class Pets_Grooming_Customize_Theme_Control extends WP_Customize_Control {
	...
	protected function end_render_field() {
		if ( ! empty( $this->input_attrs['data-pro-only'] ) ) {
			pets_grooming_show_layout( pets_grooming_add_inherit_cover( $this->id, array( 'type' => $this->type, 'pro_only' => true ) ) );
		}
		?>
		</div>
		<?php
	...
	protected function render_field_description() {
		if ( ! empty( $this->description ) ) {
			?>
			<span class="customize-control-description description"><?php pets_grooming_show_layout( $this->description ); ?></span>
			<?php
		}
	}
...
/**
 * Class Pets_Grooming_Customize_Info_Control.
 * 
 * A control to display an information block in the Customizer.
 */
class Pets_Grooming_Customize_Info_Control extends Pets_Grooming_Customize_Theme_Control {
	public $type = 'info';
...
/**
 * Class Pets_Grooming_Customize_Hidden_Control.
 * 
 ...
 */
class Pets_Grooming_Customize_Hidden_Control extends Pets_Grooming_Customize_Theme_Control {
	public $type = 'hidden';
	...
	protected function render_content() {
		...
		if ( 'last_option' == $this->id && pets_grooming_storage_get( 'need_footer_scripts', false ) ) {
			pets_grooming_storage_set( 'need_footer_scripts', false );
...
/**
 * Class Pets_Grooming_Customize_Button_Control.
 * 
 ...
 */
class Pets_Grooming_Customize_Button_Control extends Pets_Grooming_Customize_Theme_Control {
	public $type = 'button';
	...
	protected function render_content() {
		...
		if ( ! empty( $this->input_attrs['link'] ) ) {
			...
			<a href="<?php echo esc_url( $this->input_attrs['link'] ); ?>"<?php
				echo pets_grooming_external_links_target( true );
...
/**
 * Class Pets_Grooming_Customize_Switch_Control.
 * 
 * A control to render a switch (toggle) input in the Customizer.
 * This control allows users to toggle a setting on or off.
 */
class Pets_Grooming_Customize_Switch_Control extends Pets_Grooming_Customize_Theme_Control {
	public $type = 'switch';
	...
	protected function render_content() {
		...
		$this->render_field_description();
		?>
		<label class="customize-control-field-wrap pets_grooming_options_item_switch">
			<input type="hidden"
				<?php
				$this->link();
				if ( ! empty( $this->input_attrs['var_name'] ) ) {
...
/**
 * Class Pets_Grooming_Customize_Icon_Control.
 * 
 ...
 */
class Pets_Grooming_Customize_Icon_Control extends Pets_Grooming_Customize_Theme_Control {
	public $type = 'icon';
...
/**
 * Class Pets_Grooming_Customize_Checklist_Control.
 * 
 * A control to render a checklist input in the Customizer.
 * This control allows users to select multiple options from a list.
 */
class Pets_Grooming_Customize_Checklist_Control extends Pets_Grooming_Customize_Theme_Control {
...
/**
 * Class Pets_Grooming_Customize_Choice_Control.
 * 
 ...
 */
class Pets_Grooming_Customize_Choice_Control extends Pets_Grooming_Customize_Theme_Control {
	public $type = 'choice';
...
/**
 * Class Pets_Grooming_Customize_Scheme_Editor_Control.
 * 
 * A control to render a scheme editor in the Customizer.
 * This control allows users to edit each color scheme from the skin.
 */
class Pets_Grooming_Customize_Scheme_Editor_Control extends Pets_Grooming_Customize_Theme_Control {
		...
		/>
			...
			pets_grooming_show_layout(
				pets_grooming_show_custom_field(
					...
					$this->input_attrs,
					pets_grooming_unserialize( $this->input_attrs['value'] )
				)
			);
			?>
		</span>
...
/**
 * Class Pets_Grooming_Customize_Text_Editor_Control.
 * 
 * A control to render a text editor in the Customizer.
 * This control allows users to input rich text content.
 */
class Pets_Grooming_Customize_Text_Editor_Control extends Pets_Grooming_Customize_Theme_Control {
	...
	protected function render_content() {
		...
		pets_grooming_storage_set( 'need_footer_scripts', true );
	}
}


/**
 * Class Pets_Grooming_Customize_Range_Control.
 * 
 ...
 */
class Pets_Grooming_Customize_Range_Control extends Pets_Grooming_Customize_Theme_Control {
	public $type = 'range';
	...
	protected function render_content() {
		...
		<span class="customize-control-field-wrap"><input type="<?php echo ! $show_value ? 'hidden' : 'text'; ?>" 
			...
			$this->link();
			if ( $show_value ) {
				echo ' class="pets_grooming_range_slider_value"';
			}
			if ( ! empty( $this->input_attrs['var_name'] ) ) {
				echo ' data-var_name="' . esc_attr( $this->input_attrs['var_name'] ) . '"';
			}
